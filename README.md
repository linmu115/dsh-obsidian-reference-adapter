...
当前版本 **0.3.4-rc2.16**，面向 **DSH 0.1.5-rc.2**。它把 Obsidian 笔记选段接入 Annotation Core 的 `obsidian-note` 引用类型，负责领取、来源核对、提交回链和双向删除。通常随 [Obsidian Session Reference Suite](https://github.com/linmu115/dsh-obsidian-session-reference-suite/blob/codex/rc2-session-context-graph/README.md) 一起安装。
